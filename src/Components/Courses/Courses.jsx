...
export default function Courses() {
  return (
    <>
      ...
      <section className="relative py-12 bg-[#F6F7FB] px-4 sm:px-8 md:px-16 lg:px-32" id="courses">
  <div className="container mx-auto">
    <div className="absolute inset-0 w-full h-full -z-10"></div>

    {/* Section Header */}
    <div className=" mb-12 flex items-start flex-col justify-center py-8 ">
      <h3 className="text-[#84BA3F] text-lg md:text-xl font-semibold uppercase Section-header">Popular Courses</h3>
      <h2 className="text-2xl md:text-3xl font-bold text-[#20222E] mt-3 tracking-wide">Discover Your Course</h2>
    </div>

    {/* Courses Grid */}
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:gap-6  lg:gap- md:gap-14 sm:gap-20 ">
      {/* Arabic Class */}
      <div className="bg-white  shadow-lg rounded-2xl md:p-6  flex flex-col items-center transition-transform transform hover:scale-105 hover:shadow-xl">
        <div className="relative -mt-16 w-72 h-40 flex items-center justify-center">
          <img src={Arabic} alt="Arabic Class" className="w-full h-full object-cover rounded-xl transition-transform duration-300 hover:-translate-y-2 shadow-lg" />
        </div>
      ...
      <div className="bg-white shadow-lg rounded-2xl p-6 flex flex-col items-center transition-transform transform hover:scale-105 hover:shadow-xl">
        <div className="relative -mt-16 w-72 h-40 flex items-center justify-center">
          <img src={English} alt="English Class" className="w-full h-full object-cover rounded-xl transition-transform duration-300 hover:-translate-y-2 shadow-lg" />
        </div>
      ...
      <div className="bg-white shadow-lg rounded-2xl p-6 flex flex-col items-center transition-transform transform hover:scale-105 hover:shadow-xl">
        <div className="relative -mt-16 w-72 h-40 flex items-center justify-center">
          <img src={Math} alt="Math Class" className="w-full h-full object-cover rounded-xl transition-transform duration-300 hover:-translate-y-2 shadow-lg" />
        </div>
        <h2 className="text-xl font-semibold text-gray-900 mt-4">Math Class</h2>
        <p className="text-gray-600 text-sm text-center mt-2">
          Develop critical problem-solving skills and enhance logical thinking through engaging math activities.
        </p>
        <div className="flex justify-between w-full text-gray-700 text-sm mt-4">
          <span className="text-md font-bold text-[#84BA3F]">Age: 2-5 y</span>
          <span className="text-md font-bold text-[#84BA3F]">Weekly: 5 Days</span>
