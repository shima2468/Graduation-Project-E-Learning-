  ...
  return (
       ...
       <section id="home" className="relative  ">
        ...
        >
          ...
          {/* القسم الأيسر */}
          <div className=" lg:container mx-auto px-4 left-section flex items-center  w-full md:w-1/2  lg:gap-6 md:gap-6 justify-center md:pl-10">
            ...
            <div className="hero-desc animate_animated  animate_fadeInUp w-[98%]">
              <img
                src={doll}
                alt=""
                className="md:-mb-4 md:-ml-4 sm:ml-[260px] sm:-mb-4 md:w-18 sm:w-12   animate__animated animate__bounce animate__infinite	infi"
              />
              ...
              <div className="flex-wrap sm:flex-nowrap gap-5 hero-button flex space-x-4 xl:mt-12 xl:text-lg md:text-[15px] lg:text-md  sm:text-sm lg:mt-8 md:mt-6 md:justify-start sm:justify-center sm:mt-5">
                ...
                <button className="text-nowrap button1 border border-[#84BA3F] second-color xl:py-4 xl:px-8 lg:py-3 lg:px-6 md:py-2 md:px-4 sm:px-12 sm:py-3 rounded-2xl  hover:bg-[#c5ec91]">
                  Get In Touch →
                </button>
              </div>
            </div>
