  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center mb-8">
      <h2 className="text-4xl font-bold main-color my-6 tracking-wider text-center">
        Manage Sections Classes
      </h2>
      <h3 className="text-xl font-semibold main-color">Sections Classes</h3>
    </div>
      ...
      <table className="w-full bg-white shadow-lg rounded-md overflow-hidden">
        <thead className="text-left">
          <tr>
            ...
            <th className="p-4 main-color">Sections Name (Arabic)</th>
            <th className="p-4 main-color">Sections Name (English)</th>
            <th className="p-4 main-color">Stage</th>
            <th className="p-4 main-color">class</th>
            <th className="p-4 main-color">Teacher Name</th>
          ...
          {classes.length > 0 ? (
            classes.map((classItem) => (
              <tr key={classItem.id} className="border-b">
                ...
                <td className="p-4 main-color">{classItem.grade}</td>
            ...
            <tr>
              <td colSpan="7" className="p-4 main-color text-center text-gray-500">
    ...
    {isModalOpen && (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
        <div className="bg-white p-10 rounded-md w-[700px] h-[550px] shadow-lg relative">
          <button
          ...
          <h3 className="text-xl font-bold mb-6 main-color">Add New Section</h3>
          <form>
            <div className="grid grid-cols-2 gap-6 mb-4">
              <div>
                <label className="block mb-2 main-color font-medium">Section Name (Arabic)</label>
                <input
                  type="text"
                  name="nameAr"
              ...
              <div>
                <label className="block mb-2 main-color font-medium">Section Name (English)</label>
                <input
                  type="text"
                  name="nameEn"
            ...
            <div className="grid grid-cols-2 gap-6 mb-4">
              ...
              <div>
                <label className="block mb-2 main-color font-medium">class</label>
                <input
                  type="text"
                  name="grade"
            ...
            <div className="mb-3">
              <label className="block mb-2 main-color font-medium">Teacher Name</label>
              <textarea
                name="notes"
