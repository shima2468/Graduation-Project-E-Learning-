  ...
  return (
    <>
      ...
      <section id="home relative">
        <div
          className="absolute z-[-1] custom-image hidden md:hidden lg:block
             right-0  
             w-[40vw] max-w-[600px] lg:max-w-[400px] xl:max-w-[500px]"
        >
        ...
        <div
          className="Hero py-24 container mx-auto min-h-screen w-full relative px-4 
             xl:mt-24 lg:mt-40 md:mt-[-5%] sm:mt-20"
        >
          <div
            className="hero-content relative w-full flex flex-col lg:flex-row md:flex-row 
                  items-center justify-between space-y-12 lg:space-y-0 sm:space-y-[4%] " 
          >
            ...
            <div
              className="right-section relative w-full flex justify-center 
                    ...
                    lg:w-1/2 md:w-2/3 sm:w-full lg:ms-[0%] "
            >
              <div className="relative max-w-[90%] lg:max-w-[80%] md:max-w-[90%] sm:max-w-[70%]  lg:mt-[0%] md:mt-[20%]  ">
                <img
                  src={hero}
                  alt="Hero Image"
            ...
            {/* القسم الأيسر */}
            <div className="left-section flex items-center xl:space-x-10 lg:space-x-6 md:space-x-0 ">
                                            <div className="lg:flex flex-col items-center xl:space-y-4 lg:space-y-2 md:hidden sm:hidden xl:ms-[-2%] lg:ms-[2%]">
                                          {/* الخط العلوي */}
                                          <div className="xl:h-16  xl:w-[2px] lg:h-14 lg:w-[2px] bg-gradient-to-b from-[#84BA3F] to-transparent"></div>

                                          {/* الدائرة الأولى */}
                                          <div className="xl:w-4 xl:h-4 lg:w-3 lg:h-3 bg-[#84BA3F] rounded-full my-2"></div>

                                          {/* الدائرة الثانية (المحاطة) */}
                                          <div className="xl:w-8 xl:h-8 lg:w-6 lg:h-6 border-2 border-[#84BA3F] rounded-full flex items-center justify-center my-2">
                                            <div className="xl:w-4 xl:h-4 lg:w-3 lg:h-3 bg-[#84BA3F] rounded-full"></div>
                                          </div>
                                          ...
                                          {/* الخط السفلي */}
                                          <div className="xl:h-16  xl:w-[2px] lg:h-14 lg:w-[2px] bg-gradient-to-t from-[#84BA3F] to-transparent"></div>
                                            </div>
                                            <div className="hero-desc animate__animated  animate__fadeInUp ">
                                                  ...
                                                  <div className="second-color xl:font-medium  mb-2">Welcome to Kidsa</div> 
                                                          <h1 className="hero-heading xl:text-6xl lg:text-5xl md:text-4xl sm:text-5xl font-bold main-color xl:leading-tight xl:tracking-wider lg:leading-tight lg:tracking-wider md:leading-tight md:tracking-wide">
                                                        ...
                                                        <div className="hero-button flex space-x-4 xl:mt-12 xl:text-lg md:text-[15px] lg:text-md  sm:text-sm lg:mt-8 md:mt-6 md:justify-start sm:justify-center sm:mt-5">
