...
import Img from "../../assets/pexels-photo-5212664.jpeg"
export default function Contact() {
  return (
    <div className="flex flex-col lg:flex-row  py-20  container mx-auto space-x-12" id="Contact">
      {/* القسم الأيسر */}
      <div className=" p-4 rounded-xl lg:w-1/2 flex flex-col contact-img relative max-h-fit py-20 ">
